<div class="modal fade" id="negotiateModal-{{ $hiringRequestId }}" tabindex="-1" aria-labelledby="negotiateModalLabel" aria-hidden="true">
                            ...
                            <tr>
                                ...
                                <td class="border border-secondary-subtle">
                                    <div class="input-group">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <input type="text" class="form-control text-center ps-0 pe-0 border-secondary-subtle" wire:model.defer="clientPricing" id="offerInput">
                                ...
                                <td class="border border-secondary-subtle">
                                    <div class="input-group">
                                        <div class="d-flex align-items-center">
                                            <span class="ms-0 me-2 ">₱</span>
                                            <input type="text" class="form-control text-center ps-0 pe-0 border-secondary-subtle" wire:model.defer="freelancerPricing" id="offerInput">
