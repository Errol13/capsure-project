        ...
        <div class="row rounded-4" style="background-color: white;">
            ...
            <div class="col-8 col-md-8 col-lg-8 poppins-regular" style="border-left: 15px solid #F8FAFC;">
                <div class="row my-3 ps-4">
                    ...
                    <p class="fs-6 my-2 open-sans-reg light-color-prof ">Rating</p>
                    @if($user->client->avg_rating == 0)
                    <p class="fs-6 open-sans-reg light-color-prof fst-italic text-muted">No ratings yet</p>
                    @else
                    ...
                    <div class="d-flex justify-content-start align-items-start my-2 mt-md-3">
                        ...
                        <button type="button" class="rounded btn-report me-2 px-3 px-md-5 py-1 py-md-1 poppins-light fs-sm" data-bs-toggle="modal" data-bs-target="#reportClientModal">Report</button>
